...
(function() {
  ...
  module.exports = PossibleActionsApplicationService = (function() {
    ...
    PossibleActionsApplicationService.prototype.getArrowAttacks = function() {
      var arrows, distance, i, j, k, len, neighbourToken, possibilities, ref, ref1;
      possibilities = [];
      if (this.token.playerId === this.game.gameState.activePlayer) {
        arrows = (function() {
          var j, results;
        ...
        for (j = 0, len = arrows.length; j < len; j++) {
          i = arrows[j];
          distance = 0;
          for (distance = k = ref = Config.ARROW_MIN_DISTANCE, ref1 = Config.ARROW_MAX_DISTANCE; ref <= ref1 ? k <= ref1 : k >= ref1; distance = ref <= ref1 ? ++k : --k) {
            neighbourToken = this.getToken(this._getDistantField(this.position, distance, i));
    ...
    PossibleActionsApplicationService.prototype._getDistantField = function(pos, distance, direction) {
