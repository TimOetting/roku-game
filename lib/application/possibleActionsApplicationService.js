...
(function() {
  var Position, PossibleActionsApplicationService, Weapon;
  ...
  module.exports = PossibleActionsApplicationService = (function() {
    function PossibleActionsApplicationService(board, position1) {
    ...
    PossibleActionsApplicationService.prototype.hasToken = function(position) {
      var j, len, ref, token;
