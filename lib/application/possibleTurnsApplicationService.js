...
(function() {
  var Position, PossibleTurnsApplicationService, Weapon;

  Position = require('../domain/position');

  Weapon = require('../domain/weapon');

  module.exports = PossibleTurnsApplicationService = (function() {
    function PossibleTurnsApplicationService(board, position1) {
    ...
    PossibleTurnsApplicationService.prototype.isFieldInsideBounds = function() {
      var ref, ref1;
      return (0 <= (ref = this.position.x) && ref <= 6) && (0 <= (ref1 = this.position.y) && ref1 <= 5);
    };

    PossibleTurnsApplicationService.prototype.hasToken = function(position) {
      var j, len, ref, token;
    ...
    PossibleTurnsApplicationService.prototype.getMoves = function() {
    ...
    PossibleTurnsApplicationService.prototype.getSwordAttacks = function() {
    ...
    PossibleTurnsApplicationService.prototype.getArrowAttacks = function() {
    ...
    return PossibleTurnsApplicationService;
